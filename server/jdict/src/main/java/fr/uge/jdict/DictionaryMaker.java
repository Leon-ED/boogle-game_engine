...
public class DictionaryMaker {
    ...
    public static void main(String[] args){
        ...
        if(args.length < 4){
            ...
            // String json_PATH = "E:\\Emplacements\\Bureau\\boogle\\real\\server\\files\\dumps\\dump-wikipedia2.json";
        ...
        IndexMaker.getIndexMaker("E:\\Emplacements\\Bureau\\boogle\\real\\server\\files\\dumps\\dictionary.index",json_PATH);
        try{
